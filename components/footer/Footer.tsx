...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden w-full p-14 flex flex-col space-y-4 sm:flex-row sm:justify-between space-x-5 items-center shadow-lg bg-zinc-100 dark:bg-[#222] shadow-black dark:shadow-gray-200">
      <FooterCircles />
