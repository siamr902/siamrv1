  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        {tech.map((technology) => (
          <div key={technology} className="text-3xl lowercase p-2 opacity-70">
            {technology}
          </div>
        ))}
      </div>
      <p className="text-2xl leading-10 tracking-wider max-h-[35vh] overflow-y-auto scrollbar-thin font-brush">
        {description}
      </p>
