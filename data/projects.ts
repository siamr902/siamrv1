...
export const projects: ProjectProps[] = [
  ...
  },
  {
    ...
    description:
      "A mini-collection of animated algorithms to help visualize programming concepts like backtracking, recursive dynamic programming, queues, and more. The primary intention of this project was to practice adopting certain pieces of logic into their respective code variants. Examples include a sudoku backtracking visualization with solving functionality, a visualization of Leetcode's Minimum Path Sum, a visualization of the classic N-Queens problem, etc. I may consider adding more projects to the collection in the future, but for now I find them to be somewhat repetitive: figuring out how to animate the first algorithm made the others less fulfilling. Nonetheless, the initial logic was enjoyable, and the project strengthened my understanding of Typescript.",
